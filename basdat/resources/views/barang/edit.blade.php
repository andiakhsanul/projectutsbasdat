                    ...
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url('barangs/'.$barangs->id_barang) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_barang" value="{{ $barangs->nama_barang }}" class="form-control" autofocus required>
                            </div>
                            <div class="form-group">
                                <label>Harga</label>
                                <input type="text" name="harga" value="{{ $barangs->harga }}" class="form-control" autofocus required>
                            </div>
